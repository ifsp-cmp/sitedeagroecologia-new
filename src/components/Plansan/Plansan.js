    ...
    return(
        <div className="container-fluid Plansan">
                    ...
                    <div className="card">
                        <div className="card-body fundo_cinza">
                            ...
                            <p className="card-text">
                                <ul>
                                 <li><a href="http://mds.gov.br/caisan-mds" target="_blank">Caisan</a></li>
                                </ul>
                            </p>
                        </div>
                    </div>
            ...
            <div className="row">
                ...
                <div className="col-md-8">
                    <div className="card">
                        <div className="card-title planos">PLANSAN 2012-2015</div>
                    </div>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-md-8">
                    <div className="card">
                        <div className="card-body fundo_cinza">
                            ...
                            <p className="card-text">
                                <ul>
                                 <li><a href="http://www.mds.gov.br/webarquivos/publicacao/seguranca_alimentar/Plano_Caisan.pdf" target="_blank">Plano Nacional de Segurança Alimentar e Nutricional</a></li>
                                </ul>
                            </p>
                        </div>
                    </div>
            ...
            <div className="row">
                ...
                <div className="col-md-8">
                    <div className="card">
                        <div className="card-title planos">PLANSAN 2016-2019</div>
                    </div>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-md-8">
                    <div className="card">
                        <div className="card-body fundo_cinza">
                            ...
                            <p className="card-text">
                                <ul>
                                 <li><a href="http://www.mds.gov.br/webarquivos/arquivo/seguranca_alimentar/caisan/Publicacao/Caisan_Nacional/PLANSAN%202016-2019_revisado_completo.pdf" target="_blank">II PLANO NACIONAL DE SEGURANÇA ALIMENTAR E NUTRICIONAL</a></li>
                                 <li><a href="http://www4.planalto.gov.br/consea/eventos/plenarias/documentos/2016/plano-nacional-de-seguranca-alimentar-e-nutricional-plansan-2016-2019-metodologia-e-estrutura" target="_blank">PLANO NACIONAL DE SEGURANÇA ALIMENTAR E NUTRICIONAL (PLANSAN 2016‐2019) - Metodologia e Estrutura</a></li>
                                </ul>
                            </p>
                        </div>
                    </div>
