...
const Planapo = () =>{
    ...
    return(
        <div>
            <TopoDaPagina menu="Políticas Nacionais" submenu="PLANAPO"></TopoDaPagina>
            <div className="container-fluid Planapo">
                ...
                <div className="row">
                    ...
                    <p>Com o <strong>PLANAPO 2016-2019</strong>, são assentadas as bases para a continuidade do processo de consolidação e aperfeiçoamento da política de agroecologia e produção orgânica, com a consciência de que há muito para se avançar, mas também com a convicção da importância da construção deste caminho para recolocar a produção agrícola em uma relação sustentável com o meio ambiente. Até o momento não houve renovação de nova edição do Plano para o triênio <strong>2020-2022</strong>.</p>
                    </div>
                    <div className="col-md-2"></div>
                </div>
