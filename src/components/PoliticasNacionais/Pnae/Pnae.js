...
const Pnae = () => {
    ...
    const conteudo2 = <ul className="card-text">
        <li><a href="https://portal.cmp.ifsp.edu.br/index.php/noticias/1411-chamada-publica-aquisicao-de-generos-alimenticios-da-agricultura-familiar-pnae" target="_blank" rel="noopener noreferrer">https://portal.cmp.ifsp.edu.br/index.php/noticias/1411-chamada-publica-aquisicao-de-generos-alimenticios-da-agricultura-familiar-pnae</a></li>
    </ul>;
    ...
    return (
        <div>
            <TopoDaPagina menu="Políticas Nacionais" submenu="PNAE"></TopoDaPagina>
                        ...
                        <div className="card" >
                            <div className="card-body">
                                ...
                                <p className="card-text textoAcessar">
                                    A escola beneficiária precisa estar cadastrada no Censo Escolar realizado pelo Instituto Nacional de Estudos e Pesquisas Educacionais Anísio Teixeira (Inep/MEC). As escolas filantrópicas, comunitárias e confessionais, sem fins lucrativos, que atendam aos critérios estabelecidos na Resolução FNDE no 26/2013, são consideradas integrantes da rede pública de ensino.
                                <br></br><br></br>É importante observar que o cardápio escolar deve ser elaborado por nutricionista, respeitando os hábitos alimentares locais e culturais, atendendo as necessidades nutricionais específicas, conforme percentuais mínimos estabelecidos no artigo 14 da Resolução no 26/2013.
                                </p>
                            </div>
                        </div>
                    </div>
