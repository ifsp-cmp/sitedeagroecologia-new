            ...
            <div className="container-fluid AssentamentoMS">
                ...
                <div className="row">
                    ...
                    <div className="col-md-8 texto1">
                        ...
                        <p>E foi neste território de tantas lutas e histórias que o NEAES iniciou sua trajetória de parceria com o grupo de agricultoras e agricultores da Cooperflora. Desde agosto de 2016 estudantes, professores e pesquisadores do IFSP, Campus de Campinas, juntamente a outros amigos e profissionais empenhados em fortalecer os territórios de reforma agrária, desenvolvem ações de extensão, extensão tecnológica, pesquisa e ensino a partir dos princípios da Agroecologia para a garantir da Segurança e Soberania Alimentares e garantia do Direito Humano à Alimentação Adequada.</p>
                    </div>
                    <div className="col-md-2"></div>
                </div>
