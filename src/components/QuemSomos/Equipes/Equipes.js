...
const equipes = () => {
  const conteudo = (
    <ul className="card-text">
      <li>
        <a
          href="http://dgp.cnpq.br/dgp/espelhogrupo/272964#recursosHumanos"
          target="_blank"
          rel="noopener noreferrer"
        >
          Acesso ao Diretório do Grupo de Pesquisa NEAES no CNPq.
        </a>
      </li>
    </ul>
  );
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <img
              src={foto1}
              width="100%"
              alt={"Equipe de alunos e professores do Neaes"}
            ></img>
            <div className="texto1 ">
              ...
              <p>
                Profª Erika Batista, Drª em Ciências Sociais. Contato:{" "}
                <a
                  href="mailto:erika.batista@ifsp.edu.br"
              ...
              <p>
                Profª Mariana Saragiotto S. Alves, Drª Bióloga. Contato:{" "}
                <a
                  href="mailto:mariana.alves@ifsp.edu.br"
                  title="Envie um e-mail"
                >
                  mariana.alves@ifsp.edu.br
                </a>
              </p>
            </div>
          </div>
