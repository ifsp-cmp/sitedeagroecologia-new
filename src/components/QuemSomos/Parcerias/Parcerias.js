...
const parcerias = () =>{
    ...
    const conteudo4 = <ul className="card-text"><li style={{textDecoration: 'underline'}}>Professor Coordenador MOSOA - Luciano Pereira ( <a href="mailto:lucianopereira.sociologia@gmail.com" title="Envie um e-mail">lucianopereira.sociologia@gmail.com</a> )</li></ul>
    ...
    return(
        <div>
            <TopoDaPagina menu="Quem Somos" submenu="Parcerias"></TopoDaPagina>
